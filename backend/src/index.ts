...
app.get("/ads/search", asyncController(adsController.getAllByTitle));
...
app.post("/reset", asyncController(adsController.resetAllAds));
...
app.get("/categories/:id/ads", asyncController(categoriesController.getAds));
